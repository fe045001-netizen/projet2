...
public class Tp2 {
	...
	public static void main(String[] args) {
        ...
        do {
            System.out.println("\n=== MENU PRINCIPAL ===");
            System.out.println("1. Longueur de la plus longue sous-suite croissante");
            System.out.println("2. Trouver les pivots");
            System.out.println("3. Générer une matrice spirale");
            System.out.println("4. Plus grand rectangle de 1 dans une matrice binaire");
            System.out.println("5. Vérifier une permutation circulaire");
            System.out.println("6. Somme maximale (algorithme de Kadane)");
            System.out.println("7. Trouver l'élément majoritaire");
            System.out.println("8. Trouver les nombres manquants");
            System.out.println("9. Différence entre diagonales");
            System.out.println("10. Vérifier si une matrice 3x3 est magique");
